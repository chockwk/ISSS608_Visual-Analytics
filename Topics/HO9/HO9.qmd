...
```{r}
pacman::p_load(tidyverse, kable, lubridate, data.table, ggthemes, readxl, CGPfunctions, ggHoriPlot, ggTimeSeries) 
```
...
air_long %>% 
  ...
  labs(x = "Month_Year", y = "Value", title = "Horizon Plot of Data")
```
::: {.callout-note}
