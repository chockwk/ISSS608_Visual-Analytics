...
The output shows **6,606 observations** with **1,279 variables** where Singapore accounts for close to **1%** of the observations. The number of observations is likely to reflect the number of students who undergo the assessment.
...
4.  **Study Days**: The bar chart suggests most students study **one to two days per week**, with numbers dropping as the number of study days increases. One quarter of the students study 6 days, as hardworking as Masters students.
...
![](images/Screenshot%202024-01-21%20at%2011.44.35PM.png)
...
# 8. Peer Critique and Visualization Makeover
...
## 8.1 Data Visualization Critique
...
1.  [PISA Student Questionaire](https://www.oecd.org/pisa/data/2022database/CY8_202111_QST_MS_STQ_CBA_NoNotes.pdf)

2.  [PISA Singapore Results](https://www.oecd.org/publication/pisa-2022-results/country-notes/singapore-2f72624e/)

3.  [Introduction to corrplot Package](https://cran.r-project.org/web/packages/corrplot/vignettes/corrplot-intro.html)
