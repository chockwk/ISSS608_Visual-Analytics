...
Artificially stretch the required timeline so that it is multiple years long.
Scale the transition length to the numerical difference between each state.
:::
